defmodule MeilisearchTest do
  ...
  describe "Full tour around the api" do
    setup context do
      Meilisearch.start_link(:main, context[:meili])
      :ok
    end

    test "Instance should be healthy", _context do
      assert true =
               :main
               |> Meilisearch.client()
               |> Meilisearch.Health.healthy?()
    ...
    test "Instance should be of @meiliversion", context do
    ...
    test "List of indexes, should be empty", _context do
      assert {:ok,
